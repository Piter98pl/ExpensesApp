      ...
      child: transactions.isEmpty
          ? Column(
              children: [
                ...
                SizedBox(
                  //empty box which we dont see on the screen but wchich still occupies its space, it still occupies 10 pixels
                  height: 20,
                ),
                Flexible(
                  //Flexible helps size widgets that are relative to their parent, and if you want to adjust those widgets when their parents size changes
                  child: Image.asset(
          ...
          : ListView.builder(
              itemBuilder: (context, index) {
                ...
                //the value of context(it can be any name) well be of type BuildContext, this function is not called by me so it's not my job to provide these arguments, it's called by Flutter because it calls this builder function here  for every new item it wants to render on the screen
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    //trailing:  ,//element at the end of that ListTile
                  ),
                );
